...
var ItemCheckListService = (function () {
    function ItemCheckListService(http, _appConfig, _logservice, _authhttp) {
    ...
    ItemCheckListService.prototype.handleError = function (error) {
        return Observable_1.Observable.throw(error.json().error || 'Server error');
    };
    ItemCheckListService.prototype.getItemCheckList = function (orderNo, productCode) {
        var _this = this;
    ...
    ItemCheckListService.prototype.saveOrderStatus = function (orderNo) {
        var _this = this;
    ...
    ItemCheckListService = __decorate([
        core_1.Injectable(),
    ...
    ], ItemCheckListService);
    return ItemCheckListService;
}());
exports.ItemCheckListService = ItemCheckListService;
//# sourceMappingURL=item-checklist.service.js.map