...
var RegisterService = (function () {
    function RegisterService(http, _appConfig, _logservice, _authhttp) {
    ...
    RegisterService.prototype.registerClient = function (model) {
        var _this = this;
        var body = JSON.stringify(model);
        var headers = new http_1.Headers();
        headers.append('Content-Type', 'application/json');
        return this.authhttpservice
            .post(this.apiEndpoint + 'RegisterUser/', body, {
            headers: headers
        })
    ...
    RegisterService.prototype.sendEmail = function (model) {
        var _this = this;
        var body = JSON.stringify(model);
        var headers = new http_1.Headers();
        headers.append('Content-Type', 'application/json');
