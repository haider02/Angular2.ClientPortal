...
var ForgotPasswordService = (function () {
    function ForgotPasswordService(http, _appConfig, _logservice, _authhttp) {
    ...
    ForgotPasswordService.prototype.validateUserEmail = function (model) {
        var _this = this;
    ...
    ForgotPasswordService.prototype.forgotPassword = function (model) {
        var _this = this;
        var body = JSON.stringify(model);
        var headers = new http_1.Headers();
        headers.append('Content-Type', 'application/json');
        return this.authhttpservice
            .post(this.apiEndpoint + 'ForgotPassword', body, {
            headers: headers
        })
            .map(function (res) { return res.json(); })
