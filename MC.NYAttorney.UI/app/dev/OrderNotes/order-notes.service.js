...
var OrderNotesService = (function () {
    //end region
    /** --Constructor--
  * _http: HTTP request object
  * _appConfig: Config object injection
  **/
    function OrderNotesService(http, _appConfig, _logservice, _authhttp) {
  ...
  **/
    ...
    OrderNotesService.prototype.getNotesByOrder = function (OrderNo) {
        var _this = this;
    ...
    OrderNotesService.prototype.createNotes = function (model) {
    ...
    /** * logError: log eror**/
    OrderNotesService.prototype.handleError = function (error) {
        return Observable_1.Observable.throw(error.json().error || 'Server error');
    };
    OrderNotesService = __decorate([
        core_1.Injectable(),
...
exports.OrderNotesService = OrderNotesService;
//# sourceMappingURL=order-notes.service.js.map